...
class StoreTest {
    ...
    void addNewProduct() {
        ...
        Assertions.assertNotNull(actual);//Make this check if the product was actually added
    ...
    void searchProductByName() throws Exception {
        ...
        Assertions.assertTrue(searchResults.contains(actual1));
        Assertions.assertFalse(searchResults.contains(actual2));
    }
    ...
    void CreateProduct_Nullname() {
        Assertions.assertThrows(NullPointerException.class,()->s.AddNewProduct(null,5.0,5,"Milk","Its Milk what did you expect"));
    }
    @Test
    void CreateProduct_negativePrice() {
        Assertions.assertThrows(IllegalArgumentException.class,()->s.AddNewProduct("Milk",-5.0,5,"Milk","Its Milk what did you expect"));
    }
    @Test
    ...
    void CreateProduct_NullCategory() {
        Assertions.assertThrows(NullPointerException.class,()->s.AddNewProduct("Milk",5.0,5,null,"Its Milk what did you expect"));
    }
    @Test
    void CreateProduct_NullDesc() {
        Assertions.assertThrows(NullPointerException.class,()->s.AddNewProduct("Milk",5.0,5,"Milk",null));
    }
}