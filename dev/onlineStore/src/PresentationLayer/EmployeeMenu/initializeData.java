...
import static DomainLayer.Users.Role.*;
...
public class initializeData{
   ...
   public void show() throws Exception {
       ...
       System.out.println("1. "+ store1.getProducts().get("bamba") + " About the Product: "+ store1.getProducts().get("bamba").getDescription() + "with Rate: "
               + store1.getProducts().get("bamba").getRate() + "\n");
       System.out.println("2. "+ store2.getProducts().get("milk") + " About the Product: "+ store2.getProducts().get("milk").getDescription() + "with Rate: "
               + store2.getProducts().get("milk").getRate() + "\n");
       System.out.println("1. "+ store3.getProducts().get("beer") + " About the Product: "+ store3.getProducts().get("beer").getDescription() + "with Rate: "
