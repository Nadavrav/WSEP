...
import DomainLayer.Stores.Discounts.Conditions.BasicConditions.BooleanConditions.MaxBagPriceCondition;
import DomainLayer.Stores.Discounts.Conditions.BasicConditions.BooleanConditions.MinBagPriceCondition;
import DomainLayer.Stores.Discounts.Conditions.BasicConditions.BooleanConditions.MinTotalProductAmountCondition;
import DomainLayer.Stores.Discounts.Conditions.BasicConditions.FilterConditions.*;
import DomainLayer.Stores.Discounts.Conditions.BooleanLogicConditions.XorCondition;
import DomainLayer.Stores.Discounts.Conditions.ComplexConditions.MultiAndCondition;
import DomainLayer.Stores.Discounts.Conditions.BooleanLogicConditions.AndCondition;
import DomainLayer.Stores.Discounts.Conditions.BooleanLogicConditions.OrCondition;
import DomainLayer.Stores.Discounts.Conditions.BooleanLogicConditions.WrapperCondition;
import DomainLayer.Stores.Discounts.Discounts.AdditiveDiscount;
import DomainLayer.Stores.Discounts.Discounts.BasicDiscount;
import DomainLayer.Stores.Discounts.Discounts.MaxSelectiveDiscount;
...
//There is a 50% meat discount  only if the bag contains at least 5 breads and also at least 6 dairy products
    ...
    public void ComplexAndDiscount(){
        ...
        assertEquals(65,discount); //50% off 1 steak and 1 chicken, 50+15
    }
    ...
    public void ComplexDiscount(){
        ...
        double discount= basicDiscount.calcDiscountAmount(fullBag);
        assertEquals(30,discount); //15 from 3 milk, 45 from 3 yogurt, 60 total
    }
   ...
   public void AdditiveDiscountsTest(){
       ...
       assertEquals(42,discount); //dairy = 20, rest of store=140, 70% on dairy saving 14 and 20% on rest saving 28, total saved 42
   }
}
